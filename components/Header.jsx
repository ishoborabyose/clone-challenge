...
function Header() {
  ...
  return (
    <div>
    <div className='px-20  sm:px-3 sm:py-4  py-10 sticky top-0 z-10 w-full  bg-white flex justify-between'>
    <div className='w-[297px] h-[60px]'>
   
     <div className='sm:w-[222px] sm:h-[45px]'>
     <svg  version="1.1" id="Ebene_1" x="0px" y="0px" viewBox="0 0 297 60"   fill='#000'>
...
<g>
  ...
  <path class="st0" d="M40.4,26.4c0.9,0,1.6-0.7,1.6-1.6s-0.7-1.6-1.6-1.6c-0.9,0-1.6,0.7-1.6,1.6C38.8,25.6,39.5,26.4,40.4,26.4    L40.4,26.4z"/>
    ...
    <img className='hidden mt-2 sm:block w-[24px] h-[24px]' src="https://www.svgrepo.com/show/473963/menu-hamburger.svg" alt="" />

    <ul className='flex sm:hidden gap-3'>

       <li><img src= "https://www.svgrepo.com/show/415379/translate-languange-switch.svg" width={30} height={30} alt="" /></li>
       <li><img src= "https://www.svgrepo.com/show/473369/search.svg" width={30} height={30} alt="" /></li>
       <li onClick={() => setShow(!show)}><img src= "https://www.svgrepo.com/show/473963/menu-hamburger.svg" width={30} height={30} alt="" /></li>
   ...
   {
                 show && (
                  <div className='h-screen z-[9999] sticky top-0 bg-[#333333] bg-opacity-90 text-white -mt-36'>
                        <div className='flex items-center bg-[#333333] justify-between px-[5.625rem] py-10'>
                            <div><img className='w-[300px]' src="https://www.student.uni-stuttgart.de/system/modules/de.stuttgart.uni.v3.basics/resources/img/svg/logo-inverted-en.svg" /></div>
                            <div className='flex items-center gap-2'>
                              <span><img src="/images/Capture.PNG" width={30} height={30} /></span>
                                <span onClick={() => setShow(!show)}><img src="/images/Capture3.PNG" width={30} height={30} /></span>
                            </div>
                       </div>
                        <div className='pt-10'>
                          <div className='flex flex-col gap-5 text-lg text-white px-[5.625rem]'>
                                {
                                    ["home", "about", "contact", "blog", "pages", "More"].map((item, i) => {
                                       return (
                                           <span className='border-b-2 border-dashed p-2 hover:bg-[#00bcff]'>
                                                <Link href={item} key={i} className="flex justify-between">
                                                  <span>{item}</span>
                                                     <span> <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 64 64" stroke-width="3" stroke="#fff" fill="#444444"><polyline points="18.86 57.47 44.12 30.84 18.86 6.58"/></svg></span>
                                                 </Link>
                                             </span>
                                         )
                                     })
