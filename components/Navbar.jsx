...
function Navbar() {
  return (
    <section>
      <div className=''>
        <div className='py-1 flex px-20 bg-[#004191] leading-[28px] items-center gap-2 text-white justify-end'>
          <span>University of Stuttgart</span>
	...
	<path d="M6.854 4.146l4.353 4.354-4.354 4.354-0.707-0.707 3.647-3.647-3.647-3.646 0.708-0.708zM17 8.5c0 4.687-3.813 8.5-8.5 8.5s-8.5-3.813-8.5-8.5 3.813-8.5 8.5-8.5 8.5 3.813 8.5 8.5zM16 8.5c0-4.136-3.364-7.5-7.5-7.5s-7.5 3.364-7.5 7.5 3.364 7.5 7.5 7.5 7.5-3.364 7.5-7.5z" fill="#fff"/>
        ...
        <div className='px-20 py-10 bg-white flex justify-between'>
	...
	<g>
		...
		<path class="st0" d="M40.4,26.4c0.9,0,1.6-0.7,1.6-1.6s-0.7-1.6-1.6-1.6c-0.9,0-1.6,0.7-1.6,1.6C38.8,25.6,39.5,26.4,40.4,26.4    L40.4,26.4z"/>
          ...
          <ul className='flex gap-3'>
            {
              ["https://www.svgrepo.com/show/415379/translate-languange-switch.svg" , "https://www.svgrepo.com/show/473369/search.svg" ,"https://www.svgrepo.com/show/473963/menu-hamburger.svg"].map((item) =>{
                return(
                  <Link className='w-[24px] h-[24px]' href={item}>
                    <img src= {item} alt="" />
